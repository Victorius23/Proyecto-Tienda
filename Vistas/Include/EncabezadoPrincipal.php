<?php
	include_once("Vistas/Global/variables.php");
?>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		...
		<div class="container-fluid" style="background-color: black;text-align: center;">
			<img src="Vistas/Imagenes/Logoo.png" width="320" height="140">
		...
		<div class="container-fluid" style="background-color: #D50600; text-align: center; font-size: 20px">
			<div style="padding-top: 10px;padding-bottom: 15px;font-family: candara">
				...
				<ul class="nav justify-content-center">
				  ...
				  <li class="nav-item">
				    <a class="nav-link" href="Vistas/Registro_Usuarios.php" style="color: white">Registrarse</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link" href="Vistas/Autentificación.php" style="color: white">Autentificarse</a>
				  </li>
				</ul>
