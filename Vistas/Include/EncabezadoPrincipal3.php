		...
		<div class="container-fluid" style="background-color: #D50600; text-align: center; font-size: 20px">
			<div style="padding-top: 10px;padding-bottom: 15px;font-family: candara">
				...
				<ul class="nav justify-content-center">
				  ...
				  <li class="nav-item">
				    <a class="nav-link" href="Registro_Usuarios.php" style="color: white">Registrarse</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link" href="Autentificación.php" style="color: white">Autentificarse</a>
				  </li>
				</ul>
